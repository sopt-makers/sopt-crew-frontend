...
import { LightningFormType, MAX_FILE_SIZE } from '@type/form';
...
import { lightningPlace, lightningTags, lightningTime } from '@data/options';
...
interface PresentationProps {
  ...
  disabled?: boolean;
  errors: FieldErrors<LightningFormType>;
}
