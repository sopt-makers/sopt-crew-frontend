...
var _toConsumableArray = _interopDefault(require('@babel/runtime/helpers/toConsumableArray')),
  ...
  _classCallCheck = _interopDefault(require('@babel/runtime/helpers/classCallCheck')),
  _createClass = _interopDefault(require('@babel/runtime/helpers/createClass')),
  _assertThisInitialized = _interopDefault(require('@babel/runtime/helpers/assertThisInitialized')),
  _inherits = _interopDefault(require('@babel/runtime/helpers/inherits')),
  _possibleConstructorReturn = _interopDefault(require('@babel/runtime/helpers/possibleConstructorReturn')),
  _getPrototypeOf = _interopDefault(require('@babel/runtime/helpers/getPrototypeOf')),
  _defineProperty = _interopDefault(require('@babel/runtime/helpers/defineProperty')),
  React = require('react'),
  React__default = _interopDefault(React),
  invariant = _interopDefault(require('invariant')),
  _slicedToArray = _interopDefault(require('@babel/runtime/helpers/slicedToArray')),
  _objectWithoutProperties = _interopDefault(require('@babel/runtime/helpers/objectWithoutProperties')),
  ...
  findPositionOfCapturingGroup = function (markup, parameterName) {
    invariant(
      ...
      'Second arg must be either "id" or "display", got: "'.concat(parameterName, '"')
    );
    ...
    return (
      ...
      invariant(
        ...
        "The markup '".concat(markup, "' does not contain either of the placeholders '__id__' or '__display__'")
      ),
      null !== indexDisplay && null !== indexId
  ...
  iterateMentionsMarkup = function (value, config, markupIteratee) {
    for (
      var match,
        textIteratee = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : emptyFn,
  ...
  mapPlainTextIndex = function (value, config, indexInPlainText) {
    var result,
      inMarkupCorrection = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 'START';
    if ('number' != typeof indexInPlainText) return indexInPlainText;
    return (
      iterateMentionsMarkup(
        value,
        config,
        function (markup, index, mentionPlainTextIndex, id, display, childIndex, lastMentionEndIndex) {
          void 0 === result &&
            mentionPlainTextIndex + display.length > indexInPlainText &&
            (result =
              'NULL' === inMarkupCorrection ? null : index + ('END' === inMarkupCorrection ? markup.length : 0));
        },
  ...
  applyChangeToValue = function (value, plainTextValue, _ref, config) {
    ...
    var mappedSpliceStart = mapPlainTextIndex(value, config, spliceStart, 'START'),
      ...
      controlSpliceStart = mapPlainTextIndex(value, config, spliceStart, 'NULL'),
      controlSpliceEnd = mapPlainTextIndex(value, config, spliceEnd, 'NULL'),
      willRemoveMention = null === controlSpliceStart || null === controlSpliceEnd,
  ...
  markupToRegex = function (markup) {
    var escapedMarkup = escapeRegex(markup),
      charAfterDisplay = markup[markup.indexOf(PLACEHOLDERS.display) + PLACEHOLDERS.display.length],
      charAfterId = markup[markup.indexOf(PLACEHOLDERS.id) + PLACEHOLDERS.id.length];
    return new RegExp(
      escapedMarkup
        .replace(PLACEHOLDERS.display, '([^'.concat(escapeRegex(charAfterDisplay || ''), ']+?)'))
        .replace(PLACEHOLDERS.id, '([^'.concat(escapeRegex(charAfterId || ''), ']+?)'))
    );
  },
    ...
    return (
      invariant(
        ...
        'Number of capturing groups in RegExp '
          ...
          .concat(numberOfGroups, ") does not match the number of placeholders in the markup '")
          .concat(markup, "' (")
  ...
  omit = function (obj) {
    ...
    return Object.keys(obj).reduce(function (acc, k) {
      return obj.hasOwnProperty(k) && !keys.includes(k) && void 0 !== obj[k] && (acc[k] = obj[k]), acc;
    }, {});
  },
...
function Highlighter(_ref) {
  ...
  return (
    iterateMentionsMarkup(
      value,
      config,
      function (markup, index, indexInPlainText, id, display, mentionChildIndex, lastMentionEndIndex) {
    ...
    renderHighlightedDisplay = function (display) {
      ...
      return -1 === i
        ...
        : React__default.createElement(
            ...
            React__default.createElement('b', style('highlight'), display.substring(i, i + query.length)),
...
function LoadingIndicator(_ref) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      'div',
      spinnerStyles,
      React__default.createElement('div', spinnerStyles(['element', 'element1'])),
      React__default.createElement('div', spinnerStyles(['element', 'element2'])),
      React__default.createElement('div', spinnerStyles(['element', 'element3'])),
      React__default.createElement('div', spinnerStyles(['element', 'element4'])),
      React__default.createElement('div', spinnerStyles(['element', 'element5']))
    )
  );
}
...
function SuggestionsOverlay(_ref) {
  var id = _ref.id,
    ...
    onMouseEnter = _ref.onMouseEnter,
    _useState = React.useState(void 0),
    _useState2 = _slicedToArray(_useState, 2),
    ...
    function () {
      if (ulElement && !(ulElement.offsetHeight >= ulElement.scrollHeight) && scrollFocusedIntoView) {
        var scrollTop = ulElement.scrollTop,
          _ulElement$children$f = ulElement.children[focusIndex].getBoundingClientRect(),
        ...
        (bottom = bottom - topContainer + scrollTop),
          (top = top - topContainer + scrollTop) < scrollTop
            ...
            : bottom > ulElement.offsetHeight && (ulElement.scrollTop = bottom - ulElement.offsetHeight);
      }
    },
  ...
  var suggestionsToRender,
    renderSuggestion = function (result, queryInfo, index) {
      var isFocused = index === focusIndex,
        ...
        renderSuggestion = React.Children.toArray(children)[childIndex].props.renderSuggestion;
  ...
  return isOpened
    ? React__default.createElement(
        ...
        ((suggestionsToRender = React__default.createElement(
          'ul',
          _extends(
            {
              ref: setUlElement,
          ...
          Object.values(suggestions).reduce(function (accResults, _ref2) {
      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(_this), 'getInputProps', function () {
          ...
          return _objectSpread$1(
            _objectSpread$1(
              _objectSpread$1(
                _objectSpread$1({}, omit(_this.props, ['style', 'classNames', 'className'], keys(propTypes))),
                style('input')
              ),
              {},
              {
        ...
        _defineProperty(_assertThisInitialized(_this), 'renderControl', function () {
          ...
          return React__default.createElement(
            ...
            singleLine ? _this.renderInput(inputProps) : _this.renderTextarea(inputProps)
          );
        }),
        ...
        _defineProperty(_assertThisInitialized(_this), 'renderSuggestionsOverlay', function () {
          ...
          return _this.props.suggestionsPortalHost
            ? ReactDOM.createPortal(suggestionsNode, _this.props.suggestionsPortalHost)
            : suggestionsNode;
        }),
        ...
        _defineProperty(_assertThisInitialized(_this), 'executeOnChange', function (event) {
          ...
          return _this.props.onChange
            ? (_this$props4 = _this.props).onChange.apply(_this$props4, [event].concat(args))
            : _this.props.valueLink
            ? (_this$props$valueLink = _this.props.valueLink).requestChange.apply(
                _this$props$valueLink,
        ...
        _defineProperty(_assertThisInitialized(_this), 'handleChange', function (ev) {
          if (
            ((isComposing = !1), isIE()) &&
            ((document.activeElement && document.activeElement.contentDocument) || document).activeElement !== ev.target
          )
            return;
          ...
          var selectionStart = ev.target.selectionStart,
            ...
            startOfMention = findStartOfMentionInPlainText(value, config, selectionStart);
        ...
        _defineProperty(_assertThisInitialized(_this), 'handleKeyDown', function (ev) {
          if (0 !== countSuggestions(_this.state.suggestions) && _this.suggestionsElement)
            switch (
              (Object.values(KEY).indexOf(ev.keyCode) >= 0 && (ev.preventDefault(), ev.stopPropagation()), ev.keyCode)
            ) {
              case KEY.ESC:
        ...
        _defineProperty(_assertThisInitialized(_this), 'selectFocused', function () {
          var _this$state2 = _this.state,
            ...
            _Object$values$reduce = Object.values(suggestions).reduce(function (acc, _ref) {
        ...
        _defineProperty(_assertThisInitialized(_this), 'updateSuggestionsPosition', function () {
          ...
          if (caretPosition && _this.suggestionsElement) {
            var suggestions = _this.suggestionsElement,
              ...
              caretHeight = getComputedStyleLengthProp(highlighter, 'font-size'),
              viewportRelative = {
            ...
            if (suggestions) {
              ...
              if (suggestionsPortalHost) {
                ...
                _left + suggestions.offsetWidth > _this.containerElement.offsetWidth
                  ? (position.right = 0)
                  : (position.left = _left),
                  (allowSuggestionsAboveCursor &&
        ...
        _defineProperty(_assertThisInitialized(_this), 'setSelection', function (selectionStart, selectionEnd) {
          if (null !== selectionStart && null !== selectionEnd) {
            var el = _this.inputElement;
            if (el.setSelectionRange) el.setSelectionRange(selectionStart, selectionEnd);
        ...
        _defineProperty(
          ...
          function (plainTextValue, caretPosition) {
            ...
            var value = _this.props.value || '',
              ...
              config = readConfigFromChildren(children),
              positionInValue = mapPlainTextIndex(value, config, caretPosition, 'NULL');
            if (null !== positionInValue) {
              var substringStartIndex = getEndOfLastMention(value.substring(0, positionInValue), config),
                substring = plainTextValue.substring(substringStartIndex, caretPosition);
        ...
        _defineProperty(
          _assertThisInitialized(_this),
          'queryData',
          function (query, childIndex, querySequenceStart, querySequenceEnd, plainTextValue) {
            var _this$props6 = _this.props,
              children = _this$props6.children,
              ignoreAccents = _this$props6.ignoreAccents,
              mentionChild = React.Children.toArray(children)[childIndex],
              syncResult = getDataProvider(mentionChild.props.data, ignoreAccents)(
                query,
        ...
        _defineProperty(
          _assertThisInitialized(_this),
          'updateSuggestions',
          function (queryId, childIndex, query, querySequenceStart, querySequenceEnd, plainTextValue, results) {
            if (queryId === _this._queryId) {
              _this.suggestions = _objectSpread$1(
                _objectSpread$1({}, _this.suggestions),
                {},
        ...
        _defineProperty(_assertThisInitialized(_this), 'addMention', function (_ref2, _ref3) {
          var id = _ref2.id,
            ...
            config = readConfigFromChildren(_this.props.children),
            _mentionsChild$props = React.Children.toArray(_this.props.children)[childIndex].props,
          ...
          var eventMock = {
            ...
            newPlainTextValue = spliceString(plainTextValue, querySequenceStart, querySequenceEnd, displayValue);
          _this.executeOnChange(eventMock, newValue, newPlainTextValue, mentions),
        ...
        _defineProperty(_assertThisInitialized(_this), 'isOpened', function () {
          return (
            ...
            (0 !== countSuggestions(_this.state.suggestions) || _this.isLoading())
          );
        }),
          ...
          value: function (event) {
            if (event.target === this.inputElement && this.supportsClipboardActions(event)) {
              ...
              var _this$state3 = this.state,
                ...
                config = readConfigFromChildren(children),
                markupStartIndex = mapPlainTextIndex(value, config, selectionStart, 'START'),
                markupEndIndex = mapPlainTextIndex(value, config, selectionEnd, 'END'),
                pastedMentions = event.clipboardData.getData('text/react-mentions'),
                pastedData = event.clipboardData.getData('text/plain'),
                newValue = spliceString(value, markupStartIndex, markupEndIndex, pastedMentions || pastedData).replace(
                  /\r/g,
                  ''
                ),
                newPlainTextValue = getPlainText(newValue, config),
                eventMock = {
                  target: _objectSpread$1(
                    _objectSpread$1({}, event.target),
                    {},
                    {
                      value: newValue,
                    }
              ...
              var nextPos =
                (findStartOfMentionInPlainText(value, config, selectionStart) || selectionStart) +
          ...
          value: function (event) {
            if (event.target === this.inputElement && this.supportsClipboardActions(event)) {
              ...
              var _this$state4 = this.state,
                ...
                markupStartIndex = mapPlainTextIndex(value, config, selectionStart, 'START'),
                markupEndIndex = mapPlainTextIndex(value, config, selectionEnd, 'END'),
                newValue = [value.slice(0, markupStartIndex), value.slice(markupEndIndex)].join(''),
                newPlainTextValue = getPlainText(newValue, config),
                eventMock = {
                  target: _objectSpread$1(
                    _objectSpread$1({}, event.target),
...
var getComputedStyleLengthProp = function (forElement, propertyName) {
  ...
  isMobileSafari = 'undefined' != typeof navigator && /iPhone|iPad|iPod/i.test(navigator.userAgent),
