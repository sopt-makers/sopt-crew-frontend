...
function Suggestion(_ref) {
  ...
  var renderHighlightedDisplay = function renderHighlightedDisplay(display) {
    ...
    return /*#__PURE__*/ React__default.createElement(
      ...
      /*#__PURE__*/ React__default.createElement('b', style('highlight'), display.substring(i, i + query.length)),
...
function LoadingIndicator(_ref) {
  ...
  return /*#__PURE__*/ React__default.createElement(
    ...
    /*#__PURE__*/ React__default.createElement(
      'div',
      spinnerStyles,
      /*#__PURE__*/ React__default.createElement('div', spinnerStyles(['element', 'element1'])),
      /*#__PURE__*/ React__default.createElement('div', spinnerStyles(['element', 'element2'])),
      /*#__PURE__*/ React__default.createElement('div', spinnerStyles(['element', 'element3'])),
      /*#__PURE__*/ React__default.createElement('div', spinnerStyles(['element', 'element4'])),
      /*#__PURE__*/ React__default.createElement('div', spinnerStyles(['element', 'element5']))
    )
  );
}
...
function SuggestionsOverlay(_ref) {
  ...
  var renderSuggestions = function renderSuggestions() {
    var suggestionsToRender = /*#__PURE__*/ React__default.createElement(
      'ul',
      _extends(
        {
          ref: setUlElement,
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), 'getInputProps', function () {
      ...
      return _objectSpread$1(
        _objectSpread$1(
          _objectSpread$1(_objectSpread$1({}, props), style('input')),
          {},
          {
    ...
    _defineProperty(_assertThisInitialized(_this), 'executeOnChange', function (event) {
      ...
      if (_this.props.valueLink) {
        ...
        return (_this$props$valueLink = _this.props.valueLink).requestChange.apply(
    ...
    _defineProperty(_assertThisInitialized(_this), 'isOpened', function () {
      return (
        isNumber(_this.state.selectionStart) && (countSuggestions(_this.state.suggestions) !== 0 || _this.isLoading())
      );
    });
  ...
  _createClass(MentionsInput, [
    ...
    },
    {
      ...
      value: function handlePaste(event) {
        ...
        var newValue = spliceString(value, markupStartIndex, markupEndIndex, pastedMentions || pastedData).replace(
          /\r/g,
          ''
        );
